...
## Parent Skill
This is a child skill of:

`procurement-skill.md`

Use the parent skill for general procurement principles, risk lenses, output standards, public procurement fairness, human review expectations, and AI guardrails.

Use this child skill when the specific workflow is SLA, KPI, or performance requirement review.
