...
Use the parent skill for general procurement principles, risk lenses, fairness expectations, output standards, human review points, and guardrails.

Use this child skill when the specific workflow is pricing model review.
