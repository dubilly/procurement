...
Use the parent skill for general procurement principles, risk lenses, output standards, human review expectations, confidentiality, public procurement fairness, and AI guardrails.

Use this child skill when the specific workflow is RFx drafting.
