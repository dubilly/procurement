...
## Parent Skill
This is a child skill of `procurement-skill.md`.

Use the parent skill for general procurement principles, confidentiality, fairness, output standards, risk lenses, escalation requirements, and human decision points.
